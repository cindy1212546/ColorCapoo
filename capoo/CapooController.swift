...
class CapooController: UIViewController {
    ...
    @IBOutlet weak var likecapoo: UIImageView!
    @IBOutlet weak var unlikecapoo: UIImageView!
    @IBOutlet weak var tmp: UIImageView!
    @IBAction func send(_ sender: Any) {
        if like.isOn == true{
            likecapoo.isHidden = false
            unlikecapoo.isHidden = true
            print("yes")
        }
        else{
            likecapoo.isHidden = true
            unlikecapoo.isHidden = false
            print("no")
        }
        if like.isOn == true{
